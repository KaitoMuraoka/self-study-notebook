...
\end{eqnarray*}
となる。$j_k$は$0$または$1$の値をとる古典ビットである。$\lambda$は$e^{i\lambda}$の形のみ出てくるので、$0 \leq \lambda \leq 2\pi$として一般性を失わない。この2進数展開を少数の表記にならって書くと、
\begin{eqnarray*}
    \frac{\lambda}{2\pi} = \frac{j_1}{2^1} + \frac{j_2}{2^2} + \cdots + \frac{j_k}{2^k} + \cdots \\
    \Leftrightarrow \lambda = (2\pi)0.j_1j_2 \cdots j_k \cdots
\end{eqnarray*}
 以下、簡単のため、$\lambda / 2\pi$は小数点以下$n$桁で書けるものとする。
 \begin{eqnarray*}
